...
void ShowHeadpackMenu(CPlayer@ player)
{
	...
	string description = getTranslatedString("Choose a headpack");
	...
	if (menu !is null)
	{
		...
		CGridButton@ separator = menu.AddTextButton(getTranslatedString("Select a headpack you want"), Vec2f(MAX_WIDTH, separator_height));
