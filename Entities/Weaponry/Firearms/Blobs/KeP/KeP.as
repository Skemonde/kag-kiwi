...
const Vec2f MUZZLE_OFFSET 			= Vec2f(6,-2.5);
const Vec2f SPRITE_TRANSLATION  	= Vec2f(7, -0.5);

//Ammo
const uint8 CLIP        			= 40; //Amount of space in the clip
...
const string CLIP_SPRITE 			= "kep_magazine.png"; //Sprite used for ejected clips/mags
...
const int8  B_SPREAD 				= 30; //Bullet Spread as degrees of an arc.
...
const string FIRE_SOUND    			= "cock_shot.ogg";
...
const string RELOAD_SOUND  			= "metal_slug_fullok.ogg"; //Plays when done reloading
