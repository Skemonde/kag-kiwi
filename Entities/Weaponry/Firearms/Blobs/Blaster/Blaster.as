...
const Vec2f MUZZLE_OFFSET 			= Vec2f(6,-3);
...
//Firing
const uint8 FIRE_INTERVAL 			= 12; //Time between trigger pulls (in ticks)
...
//Damage
const float B_DAMAGE 				= 3; //How many hearts of health the gun damages
const u8 DMG_TYPE 					= HittersKIWI::cos_will;
...
const string FIRE_SOUND    			= "blaster_shot.ogg";
const string LOAD_SOUND  			= "pistol_load.ogg"; //Plays at the start of each reload, and with every round loaded if the gun takes multiple rounds to reload
