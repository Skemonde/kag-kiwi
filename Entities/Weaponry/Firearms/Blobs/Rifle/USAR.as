...
const Vec2f SPRITE_TRANSLATION = Vec2f(7, -1);

//Ammo
const uint8 CLIP        = 5; //Amount of space in the clip
const uint8 TOTAL       = 0; //The amount of 'spare' ammo a gun can store
const string AMMO_TYPE   = "highpow"; //Blob used when reloading

//Reload
const uint8 RELOAD_HANDFED_ROUNDS = 5; //Gun loads X rounds at a time and can cancel reloads halfway. 0 turns this off and fully reloads weapon.
...
//Firing
const uint8 FIRE_INTERVAL = 20; //Time between trigger pulls (in ticks)
...
const string CLIP_SPRITE = "rifle_magazine.png"; //Sprite used for ejected clips/mags
...
const string FIRE_SOUND    = "rifle_shot.ogg";
...
const string RELOAD_SOUND  = "rifle_cycle.ogg"; //Plays when done reloading
