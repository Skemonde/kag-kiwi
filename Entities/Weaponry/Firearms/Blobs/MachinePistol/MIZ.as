...
const Vec2f SPRITE_TRANSLATION = Vec2f(6, -1);

//Ammo
const uint8 CLIP        = 10; //Amount of space in the clip
...
const uint8 RELOAD_TIME = 15; //Reload timer (in ticks). This is per bullet set if using handfed

//Firing
const uint8 FIRE_INTERVAL = 7; //Time between trigger pulls (in ticks)
...
const string FIRE_SOUND    = "miz_shot.ogg";
...
const string RELOAD_SOUND  = "metal_slug_rechamber.ogg"; //Plays when done reloading
