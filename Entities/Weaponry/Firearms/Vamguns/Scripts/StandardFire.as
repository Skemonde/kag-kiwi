...
{	
	...
	if (this.isAttached()) 
    {
        ...
        if(holder.isKeyPressed(key_down) && !this.get_bool("doReload")){
			...
			this.set_Vec2f("gun_trans", (Vec2f(SPRITE_TRANSLATION.x + 2, SPRITE_TRANSLATION.y - 6)
        ...
        { 
			...
			if (laser !is null)
			{
				...
				laser.SetOffset(Vec2f(flip_factor*MUZZLE_OFFSET.x,MUZZLE_OFFSET.y));
			...
			sprite.RotateBy(this.get_bool("doReload") ? (flip ? (45-60) : (315+60)) : aimangle, shoulder_joint);
		}
    } 
    else 
    {
