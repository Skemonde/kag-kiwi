...
const Vec2f MUZZLE_OFFSET = Vec2f(12,-3);
...
const uint8 RELOAD_TIME = 5; //Reload timer (in ticks). This is per bullet set if using handfed
...
const int8  B_SPREAD = 20; //Bullet Spread as degrees of an arc.
...
const string FIRE_SOUND    = "kep_shot.ogg";
