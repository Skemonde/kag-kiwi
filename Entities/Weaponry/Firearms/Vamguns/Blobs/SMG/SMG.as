...
//Firing
const uint8 FIRE_INTERVAL 	= 4; //Time between trigger pulls (in ticks)
...
const string CLIP_SPRITE 	= "spp_magazine.png"; //Sprite used for ejected clips/mags
...
const string FIRE_SOUND     = "nes_smg_shot.ogg";
