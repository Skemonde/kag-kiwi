...
void onInit( CBlob@ this )
{
	...
	if (this.getName()=="shrapnel")this.getSprite().setRenderStyle(RenderStyle::additive);
}
...
void onCollision( CBlob@ this, CBlob@ blob, bool solid, Vec2f normal, Vec2f point1 )
{
	...
	{
		Pierce( this, blob );
		if (doesCollideWithBlob( this, blob ) && this.get_u8("targets_pierced") < piercing_value)// && blob.getNetworkID() != this.get_u16("traget"))
		{
			...
			//this.set_u16("traget", blob.getNetworkID());
			this.add_u8("targets_pierced", 1);
		}
		else if (this.get_u8("targets_pierced") >= piercing_value)
			this.server_Die();
	}
}
