		...
		for (uint message_step = 0; message_step < count; ++message_step)
		{
			...
			switch (message.hitter)
			{
				...
				case HittersKIWI::bullet_pistol:
												hitterIcon = "$killfeed_pistol$"; break;
				case HittersKIWI::bullet_rifle:
												hitterIcon = "$killfeed_rifle$"; break;
				case HittersKIWI::bullet_hmg:
												hitterIcon = "$killfeed_hmg$"; break;
				...
				case HittersKIWI::high_machine_gun:
												hitterIcon = "$HIGH_MG$"; break;
...
void onInit(CRules@ this)
{
	...
	AddIconToken("$killfeed_skull$", "GUI/KillfeedIcons.png", Vec2f(32, 16), 1);
	...
	//KIWI
	AddIconToken("$killfeed_pistol$", "GUI/KillfeedIcons.png", Vec2f(32, 16), 24);
	AddIconToken("$killfeed_rifle$", "GUI/KillfeedIcons.png", Vec2f(32, 16), 25);
