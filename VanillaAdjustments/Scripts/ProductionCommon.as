...
ShopItem@ addProductionItem( CBlob@ this, const string &in  name, const string &in  iconName, const string &in  blobName,
	const string &in  description, u16 timeToMakeSecs, bool spawnInCrate, const u16 quantityLimit, CBitStream@ requirements = null, u16 quantity = 65535 )
{
	return addProductionItem( this, PRODUCTION_ARRAY, name, iconName, blobName, description, timeToMakeSecs, spawnInCrate, quantityLimit, requirements, quantity );	
}		

ShopItem@ addProductionItem( CBlob@ this, const string &in shopArray, const string &in  name, const string &in  iconName,
	const string &in  blobName, const string &in  description, u16 timeToMakeSecs, bool spawnInCrate, const u16 quantityLimit, CBitStream@ requirements, u16 quantity )
{
