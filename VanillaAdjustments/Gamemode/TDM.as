...
void Config(TDMCore@ this)
{
	...
	f32 gameDurationMinutes = 2000;//cfg.read_f32("gameDurationMinutes", 3.0f);
...
shared class TDMCore : RulesCore
{
	...
	void Update()
	{
		...
		if (true)//(rules.isIntermission() || rules.isWarmup()) && (!allTeamsHavePlayers()))  //CHECK IF TEAMS HAVE ENOUGH PLAYERS
		{
