...
const u16 heat_max = 1000;
const u16 heat_drop = heat_max-10;
...
const string required_class = "engi";
...
{
	return (this.get_u16(heat_prop) < heat_drop);
}
...
void onTick(CSprite@ this)
{
	...
	{
		f32 heat = Maths::Min(blob.get_u16(heat_prop), heat_max);
...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	{
		this.set_u16(heat_prop, heat_max);
		makeSteamPuff(this);
	}

	if (customData == Hitters::water)
	{
		s16 current_heat = this.get_u16(heat_prop) - heat_max * heat_reduction_water;
		if (current_heat < 0) current_heat = 0;
		this.set_u16(heat_prop, current_heat);
		makeSteamPuff(this);
	}
...
void onRender(CSprite@ this)
{
	...
	if ((hover && inRange) || (holder !is null && holder.isLocal()))
	{
		...
		u16 heat = blob.get_u16(heat_prop);
