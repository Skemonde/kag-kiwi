...
void onInit( CBlob@ this )
{
...

	{
		...
		addFoodItem( this, "Shark Chop", 0, "A shark chop with sauce.", 10, 1, @requirements );
	}
	{
		CBitStream requirements;
		AddRequirement( requirements, "blob", "grain", "Grain", 1 );
		addFoodItem( this, "Bread", 3, "Delicious crunchy whole-wheat bread.", 10, 1, @requirements );
	}
	{
		CBitStream requirements;
	...
	{
		CBitStream requirements;
		AddRequirement( requirements, "blob", "egg", "Egg", 1 );
		//AddRequirement( requirements, "blob", "builder", "Builder", 1 );
		addFoodItem( this, "Cake", 4, "A cake made of a builder corpse.", 20, 1, @requirements );
	}
	{
		CBitStream requirements;
		AddRequirement( requirements, "blob", "grain", "Grain", 1 );
		//AddRequirement( requirements, "blob", "trader", "   Russian", 1 );
		addFoodItem( this, "Burgir", 5, "Aburgir.", 30, 1, @requirements );
	}
