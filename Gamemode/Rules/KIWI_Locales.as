...
namespace Descriptions
{
	...
	//Scoreboard texts
	rank					= Translate("Rank\\Звание"),
	nickname				= Translate("Nickname\\Никнейм"),
	username				= Translate("KAG Username\\Имя пользователя"),
	ping					= Translate("Ping\\Пинг"),
	kills					= Translate("Kills\\Убийств"),
...
namespace Names
{
	...
	campfire				= Translate("Campfire\\Костёр"),
	...
	starter_handgun			= Translate("Rusty Revolver\\Ржавенький револьвер"),
